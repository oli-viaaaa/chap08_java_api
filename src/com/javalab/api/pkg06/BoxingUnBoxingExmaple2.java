...
public class BoxingUnBoxingExmaple2 {
	public static void main(String[] args) {
		// Boxing
		Integer obj1 = new Integer(100); // int 값을 받는 생성자
		Integer obj2 = new Integer("200");//200;만 넣어도 됨(자동 박싱, 차이 없음) // 문자열을 받는 생성자
		...
		System.out.println(dobj1.doubleValue()); //Double타입이기 때문에  doubleValue로 작성
